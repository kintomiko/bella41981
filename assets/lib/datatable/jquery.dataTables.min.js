...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"前一页"},sEmptyTable:"No data available in table",sInfo:"显示 _START_ 到 _END_ 共 _TOTAL_条",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示： _MENU_ 条",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查找:",sUrl:"",sZeroRecords:"No matching records found"},
