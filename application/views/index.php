			...
			<article class="container" style="margin:0;padding:0;max-width:1920px;">
			    <section >
			      <figure id="responsiveness" class="swipslider" >
			        <ul class="sw-slides">
			          <li class="sw-slide" >
			            <img src="http://ww2.sinaimg.cn/large/7af429c9jw1f4li6v465wj211h0ez764.jpg" >
			          </li>
			          <li class="sw-slide" >
			            <img src="http://ww3.sinaimg.cn/large/7af429c9jw1f4li6wdkwqj211h0ez41d.jpg" >
			          </li>
			          <li class="sw-slide" >
			            <img src="http://ww2.sinaimg.cn/large/7af429c9jw1f4li6vpkfzj211h0ezjuv.jpg" >
			          </li>
			        </ul>
			      </figure>
			    </section>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="services-post">
								<a class="services-icon1" href="#" onclick="signed();"><i class="fa">签</i></a>
						...
						<div class="col-md-4">
							<div class="services-post">
								<a class="services-icon2" href="https://shop156346072.taobao.com/index.htm?spm=2013.1.w5002-14153656851.2.u8AN6Q" target="_blank"><i class="fa">购</i></a>
								<div class="services-post-content">
									<h4>买买买</h4>
									<p>后援会官方纪念品商店 邂逅你的专属珍藏</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="services-post">
								<a class="services-icon3" href="http://120.25.70.206/" target="_blank"><i class="fa">珍</i></a>
								<div class="services-post-content">
									<h4>资源共享</h4>
									<p>关于她的一切</p>
								</div>
	...
	<script type="text/javascript">
		...
		function signed(){ 
			<?php if(isset($_SESSION['user'])){?>
				$.ajax({
				    type: 'POST',
				    url: "<?php echo base_url('portal/addSigned');?>",
				    async:false,
				    data: {} ,
