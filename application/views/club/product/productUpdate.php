			...
			<div class="box-content">
				<form class="form-horizontal" id="productForm" role="form" action="<?php echo base_url('club/productInsert');?>" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="grade" style="width:85px;" value="<?php echo $product->GRADE;?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">剩余库存</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="stock" style="width:85px;" value="<?php echo $product->STOCK;?>"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="taobao" value="<?php echo $product->TAOBAO;?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">描述</label>
						<div class="col-sm-3">
							<textarea name="description" rows="2" cols="40" maxlength="39" class="form-control"><?php echo $product->DESCRIPTION;?></textarea>
						</div>
					</div>
